  ...
  return (
    <main>
      <div className='text-center p-96'>
        ...
        <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Here at Tuneo, our goal is to give you the best experience when finding new music. We give you the tools to expand your music library</p>
      </div>
    </main>
  )
}
