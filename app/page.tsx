  ...
  return (
    <main>
      <div className='text-center p-96'>
        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Get the AUX every time with <span className="text-green-600 dark:text-green-500">MusicCurator</span></h1>
